...
(() => {
  ...
  function gangwon(){
    ...
    panel.innerHTML=`<div class="bc-collection-layout"><section class="bc-card"><div class="bc-collection-heading"><h3>담아둔 지역 <span id="bc-region-saved-count">0</span></h3><a class="bc-btn" href="#regions">지역 둘러보기</a></div><ul class="bc-list" id="bc-region-saved"></ul></section><section class="bc-card"><h3>저장한 여행</h3><div id="bc-journey-photo"></div><p class="bc-note" id="bc-journey-summary"></p><a class="bc-btn" href="#journey">여행 계획 열기</a></section></div><details class="bc-design-settings"><summary>저장한 디자인 실험</summary><p class="bc-note">풍경 기록의 실험 설정을 이어서 사용할 수 있습니다.</p><div class="bc-row"><a class="bc-btn" href="#lab">실험 열기</a><button class="bc-btn" id="bc-save-design">현재 설정 저장</button><button class="bc-btn" id="bc-load-design">설정 불러오기</button></div></details>`;
